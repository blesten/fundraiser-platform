...
const Delete = ({ openDelete, setOpenDelete }: IProps) => {
  ...
  return (
    <div className={`fixed top-0 left-0 bottom-0 right-0 z-40 bg-[rgba(0,0,0,.8)] transition ${openDelete ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'} flex items-center justify-center`}>

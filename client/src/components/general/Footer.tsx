...
const Footer = () => {
  return (
    <div className='mt-24 rounded-xl bg-primary px-10 py-8'>
      <div className='flex gap-16'>
        <div className='flex-1'>
          ...
          <p className='text-gray-200 mt-6'>Together, We Make a Difference</p>
        </div>
      ...
      <div className='mt-16 flex justify-between items-center'>
        <p className='text-gray-400 text-xs'>&copy; 2024 Copyright. Byte Craft Studio Sample Project.</p>
        <button className='bg-white py-3 px-6 rounded-full flex items-center gap-3 group hover:bg-secondary transition'>

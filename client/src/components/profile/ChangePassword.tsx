...
const ChangePassword = ({ openChangePassword, setOpenChangePassword }: IProps) => {
  ...
  return (
    <div className={`fixed top-0 left-0 bottom-0 right-0 bg-[rgba(0,0,0,.8)] flex items-center justify-center ${openChangePassword ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'} transition z-50 md:p-0 p-10`}>
